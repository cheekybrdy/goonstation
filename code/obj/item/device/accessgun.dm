...
/obj/item/device/accessgun
	...
	var/list/command_access_list = list(access_research_director, access_change_ids, access_ai_upload, access_teleporter, access_eva, access_heads, access_captain, access_engineering_chief, access_medical_director, access_head_of_personnel, access_head_of_security, access_sysadmin, access_money)
	...
	var/list/maxsec_access_list = list(access_armory)
