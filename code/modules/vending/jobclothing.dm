...
/obj/machinery/vending/jobclothing/security
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/under/misc/hawaiian_shirt/sec, 5)
...
/obj/machinery/vending/jobclothing/afterlife/security
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/head/helmet/bobby, 2)
		product_list += new/datum/data/vending_product(/obj/item/clothing/head/helmet/siren, 2)
		product_list += new/datum/data/vending_product(/obj/item/cloth/towel/security, 4)
		product_list += new/datum/data/vending_product(/obj/item/storage/backpack/security, 1)
		product_list += new/datum/data/vending_product(/obj/item/storage/backpack/satchel/security, 1)
...
/obj/machinery/vending/jobclothing/medical
	...
	create_products(restocked)
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/under/rank/pharmacist, 1)
		...
		product_list += new/datum/data/vending_product(/obj/item/clothing/suit/wintercoat/pharmacist, 1)
		...
		product_list += new/datum/data/vending_product(/obj/item/device/pda2/pharmacist, 2, cost=PAY_DOCTORATE/2)
		...
		product_list += new/datum/data/vending_product(/obj/item/storage/backpack/pharmacist, 1)
		product_list += new/datum/data/vending_product(/obj/item/storage/backpack/satchel/pharmacist, 1)
